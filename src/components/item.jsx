...
function Items() {
  ...
  function goToItemList() {
    ...
    sessionStorage.removeItem("itemcategory");
    sessionStorage.removeItem("itemprice");
    sessionStorage.removeItem("itemdiscription");
      ...
      <header className="text-gray-700 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <div className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span className="ml-3 text-xl">View Items</span>
          </div>
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">
              {sessionStorage.getItem("itemcategory")}
            </h2>
            ...
            <p className="leading-relaxed">
              {sessionStorage.getItem("itemdiscription")}
            </p>
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900">
                ${sessionStorage.getItem("itemprice")}
              </span>
